...
class GenerationMixin:
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
        self, inputs_tensor: torch.Tensor, model_kwargs, factors_p: Optional[torch.LongTensor] = None, factors_e: Optional[torch.LongTensor] = None, model_input_name: Optional[str] = None
    ) -> Dict[str, Any]:
        # 1. get encoder
